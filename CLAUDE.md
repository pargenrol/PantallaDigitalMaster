...
> **Nota**: `MONSTERS_DIR` en `config.py` es un legado sin uso real. El directorio activo de monstruos se obtiene siempre de `get_system(session["active_system"])["resources"]["monsters"]`.
